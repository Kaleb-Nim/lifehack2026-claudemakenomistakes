...
| `apps/consumer-bot/` | Consumer Telegram bot (Bun + grammY). Hardcoded shopper flow with in-chat simulated Visa checkout. |
...
bun run dev:bot        # needs apps/consumer-bot/.env with TELEGRAM_BOT_TOKEN
```
